    ...
    <div className="flex items-center justify-center min-h-[70vh]">
      <div className="w-full max-w-md glass rounded-2xl p-8 border border-border/30 animate-fade-in">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-secondary border border-border py-3 rounded-xl font-semibold hover:bg-accent transition disabled:opacity-50 mb-4"
        >
          ...
          {googleLoading ? "Loading..." : "Lanjutkan dengan Google"}
        </button>
